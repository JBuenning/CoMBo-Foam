...
Currently the only supported OpenFOAM version is v12 of the [openfoam.org](https://openfoam.org) branch of OpenFOAM. Support for future versions of this branch is also planned.
