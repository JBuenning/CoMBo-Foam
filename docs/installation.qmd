...
The compilation requires an active OpenFOAM environment ([OpenFOAM](https://openfoam.org), v14).
...
git clone https://gitlab.git.nrw/rwth-mbd/combo-foam.git && cd combo-foam/
./Allwmake
```
